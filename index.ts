...
const accounts: BankAccount[] = [
    ...
    new BankAccount (1011, 1000),
    new BankAccount (1021, 2000)
];

// Create customers...
const customers: Customer[] = [
    new Customer ("Muhammad", "Faizan", "Male", 19, 53153945414, accounts[0]),
    new Customer ("Syeda", "Zainab", "Female", 22, 84579237858, accounts[1]),
